...
# with command line options: step4 --conditions auto:phase2_realistic_T15 -s HARVESTING:@phase2Validation+@phase2+@miniAODValidation+@miniAODDQM --scenario pp --filetype DQM --geometry Extended2026D60 --era Phase2C10 --mc -n 100 --filein file:step3_inDQM.root --fileout file:step4.root
