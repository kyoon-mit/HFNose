...
class RunInstance:
    def __init__(self):
        ...
        self.preformat_cfgfile = '{0}/step{1}_2026D60_HGCNose_14TeV_photon_ageing_3000_E{2}_eta{3}_cfg.py'
        self.preformat_annotation = '\'step{0}_2026D60_14TeV_photon_ageing_3000_E{1}_eta:{2} nevts:{3}\''
        self.preformat_rootfile = '\'file:{0}/step{1}_photon_ageing_3000_E{2}_eta{3}{4}.root\''  
    ''
    def set_E (self, *args):
    ...
    def set_eta (self, *args):
        ...
        *args
        ...
        if any(type(arg)!=float and type(arg)!=int for arg in args):
            ...
            raise Exception("Please provide eta values above or equal to 3.0.")
        elif len(args) != 0:
            self.eta_list = args
