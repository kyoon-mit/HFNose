...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/data/t3home000/kyoon/TICL/photon_2026D47/photon_pt2/step2_photon_pt2.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step3_2026D47_14TeV_photon_pt2_eta35 nevts:100'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/data/t3home000/kyoon/TICL/photon_2026D47/photon_pt2/step3_photon_pt2.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/data/t3home000/kyoon/TICL/photon_2026D47/photon_pt2/step3_photon_pt2_inMINIAODSIM.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('file:/data/t3home000/kyoon/TICL/photon_2026D47/photon_pt2/step3_photon_pt2_inDQM.root'),
