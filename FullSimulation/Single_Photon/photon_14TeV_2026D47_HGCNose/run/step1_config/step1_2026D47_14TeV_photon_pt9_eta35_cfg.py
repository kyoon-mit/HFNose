...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step1_2026D47_14TeV_photon_pt9_eta35 nevts:100'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/data/t3home000/kyoon/TICL/photon_2026D47/photon_pt9/step1_photon_pt9.root'),
...
process.generator = cms.EDFilter("Pythia8PtGun",
        PGunParameters = cms.PSet(
                ...
                MaxPt = cms.double(9 + 0.001),
                MinPhi = cms.double(-3.14159265359),
                MinPt = cms.double(9 - 0.001),
    ...
    psethack = cms.string('single gamma pt 9')
)
