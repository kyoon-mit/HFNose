...
class RunInstance:
    def __init__(self):
        ...
        self.preformat_cfgfile = '{dir_step}/step{step}_2026D60_14TeV_muon_E{E}_eta{eta}{suffix}_cfg.py'
        self.preformat_annotation = '\'step{save_dir}_2026D60_14TeV_muon_E{step}_eta:{E} nevts:{eta}\''
        self.preformat_rootfile = '\'file:{save_dir}/step{step}_muon_E{E}_eta{eta}{suffix}.root\''
    ...
    def makeStep1ConfigFiles (self):
        ...
        for E in self.E_list:
            for eta in self.eta_list:
                ...
                preformat_dict = dict()
                preformat_dict['save_dir'] = self.top_save_dir + '/muon_E{0}_eta{1}'.format(E, eta)
                preformat_dict['E'] = E
                ...
                format_dict['psethack'] = '\'single muon E {0} eta {1}\''.format(E, eta)
