...
options.register('suffix', '_aging_3000',
                    VarParsing.multiplicity.singleton, 
                    VarParsing.varType.string,
                    "inpath suffix for aging processes")
options.register('E', 50,
                    VarParsing.multiplicity.singleton,
...
OUTPUT_DIR = os.path.abspath(os.environ['DIRDATA_HGCNOSE'] + '/NanoAOD/' + outpath + '/Aging/')
...
####
process.load("HGCNose.NanoAODProducer.HGCNanoAOD_AgingDetector_cff")
