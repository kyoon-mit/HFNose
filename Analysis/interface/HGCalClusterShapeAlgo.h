#ifndef HGCalClusterShapeAlgo_h
#define HGCalClusterShapeAlgo_h

/** \class HGCalClusterShapeAlgo
 * 
 * Modified version of RecoEcal/EgammaCoreTools/src/ClusterShapeAlgo.cc for HGCal
 *
 * \author Kyungseop Yoon, MIT
 *
 * \original author Michael A. Balazs, UVa
 */
...
class ClusterShapeAlgo
{
  ...
  private:
    void Calculate_TopEnergy ( const reco::BasicCluster &passedCluster, const HGCRecHitCollection *hits );
/*    void Calculate_2ndEnergy ( const reco::BasicCluster &passedCluster, const HGCRecHitCollection *hits );*/
/*    void Create_Map ( const HGCRecHitCollection *hits, const CaloSubdetectorTopology *topology );*/
/*    void Calculate_e2x2 ();*/
/*    void Calculate_e3x2 ();*/
/*    void Calculate_e3x3 ();*/
/*    void Calculate_e4x4 ();*/
